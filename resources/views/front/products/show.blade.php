                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="form-group quantity">
                                            ...
                                            <input class="form-control quantity-number" name="quantity" value="1">
                                            {{-- <select class="form-control quantity-number" name="quantity" data-quantity="1" >
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                                <option>4</option>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            <div class="button cart-button">
                                                <a class="btn add-to-cart" data-id="{{ $product->id }}" href="javascript:void(0)" >Add to Cart</a>
                                                {{-- <button  class="btn add-to-cart" data-id="{{ $product->id }}" type="submit" style="width: 100%;">Add to Cart</button> --}}
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-12">
